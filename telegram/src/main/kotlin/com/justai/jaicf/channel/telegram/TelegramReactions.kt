...
class TelegramReactions(
    ...
    ) = sendMessage(text, parseMode, entities, disableWebPagePreview, disableNotification, replyToMessageId, replyMarkup)
    ...
    fun sendMessage(
        ...
        api.sendMessage(
            chatId, text, parseMode, entities, disableWebPagePreview, disableNotification, replyToMessageId, replyMarkup
        ).also { addResponse(it) }
    ...
    fun image(
        ...
        replyToMessageId: Long? = null,
        replyMarkup: ReplyMarkup? = null
    ) = sendPhoto(url, caption, parseMode, captionEntities, disableNotification, replyToMessageId, replyMarkup)
    ...
    fun sendPhoto(
        ...
        api.sendPhoto(
            chatId, url, caption, parseMode, captionEntities, disableNotification, replyToMessageId, replyMarkup
        ).also { addResponse(it) }
    ...
    fun sendVideo(
        ...
        chatId, url, duration, width, height, caption, parseMode, captionEntities, disableNotification, replyToMessageId, replyMarkup
    ).also { addResponse(it) }
    ...
    fun sendAudio(
        ...
        api.sendAudio(
            chatId, url, caption, parseMode, captionEntities, duration, performer, title, disableNotification, replyToMessageId, replyMarkup
        ).also { addResponse(it) }
