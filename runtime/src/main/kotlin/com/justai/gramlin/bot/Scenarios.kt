...
class Scenarios(
    ...
    val interactive get() = all.values.filterIsInstance<GramlinInteractiveScenario>()
    ...
    fun isInteractive(scenario: String) = all[scenario] is GramlinInteractiveScenario
