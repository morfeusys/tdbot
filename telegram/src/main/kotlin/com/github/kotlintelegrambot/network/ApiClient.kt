...
class ApiClient(
    ...
    fun sendMessage(
        ...
        return service.sendMessage(
            chatId, text, parseMode, entities?.asJson, disableWebPagePreview, disableNotification,
    ...
    fun sendPhoto(
        ...
        return service.sendPhoto(
            ...
            captionEntities?.let { convertString(it.asJson) },
