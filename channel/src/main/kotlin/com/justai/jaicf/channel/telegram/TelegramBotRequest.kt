...
val TelegramBotRequest.webAppData get() = this as? TelegramWebAppDataRequest
...
data class TelegramWebAppDataRequest(
    override val update: Update,
    override val message: Message,
    val data: WebAppData
) : TelegramBotRequest, EventBotRequest(clientId = message.clientId, input = TelegramEvent.WEB_APP_DATA)
