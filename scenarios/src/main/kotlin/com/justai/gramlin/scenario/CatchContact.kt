...
import com.justai.gramlin.scenario.utils.emoji_red_circle
import it.tdlight.jni.TdApi

object CatchContact : GramlinInteractiveScenario({
    helpMarkdownText = "Catches the user when they become online. " +
            "\nOnce the user becomes online, Gramlin bot informs you with notification $emoji_red_circle\n" +
